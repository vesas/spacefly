...
public class Block2Up implements RoomBlock
{
	private Body body;
	...
	{
		sprite = G.getAtlas().createSprite("edgeA2");
		sprite.setSize(1.0f,0.5f);
		...
		v[4] = xpos + right.x * 1 + up.x * 2;
		v[5] = ypos + right.y * 1 + up.y * 2;
