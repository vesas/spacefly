...
public class Monster2 extends BaseMonster implements AnimateEntity
{
	...
	public class Brain2 extends Brain
	{
		...
		class WallDistanceCallback implements RayCastCallback
		{
			...
			public float reportRayFixture(Fixture fixture, Vector2 point, Vector2 normal, float fraction)
			{
				...
				if (o2 instanceof SlurgMonster || o2 instanceof Monster2)
				{
					// ignore monsters
					return -1;
				}
		...
		public void tick( float delta )
		{
			...
			if (cooldown <= 0)
			{
				...
				Vector2 tmp = Monster2.tmpVector;
		...
		protected void findClosestWall()
		{
			...
			Vector2 target = Monster2.tmpVector;
	...
	public Monster2(float posx, float posy)
	{
	...
	public void tick( float delta )
	{
		...
		if (cooldown <= 0)
		{
			...
			if (random.nextInt(100) < 40 && brain.canSeePlayer)
			{
				fireBullet();
			}
	...
	{
		fireBulletAtDir( gunDir, 0.25f, 3.2f, 1);
	}
...
//		pos.scl(Physics.BOX_TO_WORLD);
		...
		sprite.setPosition(pos.x - 14, pos.y - 9);
